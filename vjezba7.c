...
DirectoryPosition createDirectory(char* directoryName) { //creating new directory
	...
	newDirectory->subdirectoryPosition = NULL; //sets the pointer to subdirectories
	newDirectory->next = NULL;

	return newDirectory;
}

int push(LevelStackPosition headLevelStack, DirectoryPosition currentDirectory) { //add directory into stack
...
int pop(LevelStackPosition headLevelStack) { //"delete" last added directory from stack
